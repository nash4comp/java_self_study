...
class StreamEx8 {
    public static void main(String[] args) {
        Student5[] stuArr = { new Student5("나자바", true, 1, 1, 300),
         ...
         * System.out.println(); for(Student s : level) { System.out.println(s);
         * } }
         */
        System.out.printf("%n4. 다중그룹화(학년별, 반별)%n");
        Map<Integer, Map<Integer, List<Student5>>> stuByHakAndBan = Stream
                .of(stuArr).collect(groupingBy(Student5::getHak,
        ...
        Map<Integer, Map<Integer, Student5>> topStuByHakAndBan = Stream
                .of(stuArr)
